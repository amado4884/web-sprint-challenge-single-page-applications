...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   useRouteMatch is used in a component to get data from the url. For example, .../:id, would allow the component to find out which id that was.
1. How would you explain form validation to someone who has never programmed before?
   We need to make sure that the user is correctly inputting the necessary data, in the correct locations.
1. In 1-2 sentences, define end to end testing.
   End to End testing is a basically testing the system as a normal user would, but with edge cases and debugging (also much faster).
